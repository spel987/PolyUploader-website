...
- Protect your upload links after uploading using link protection services ([PrivateBin, SafeLinking, Filecrypt, and more](/link-protection)), either as a bundle or link by link
- Cross-platform: available on Windows, Linux, and macOS ([download and install](/installation-and-user-guide/install))
