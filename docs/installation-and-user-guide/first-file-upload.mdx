...
<head>
  ...
  <meta name="og:url" content="https://polyuploader.vercel.app/installation-and-user-guide/first-file-upload" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:image" content="https://p-u.vercel.app/assets/meta_visual.png" />
  <meta name="og:description" content="First file upload - PolyUploader. Upload your files remotely to different hosting sites." />
...
You can also import your **own API key** for some hosts to connect your account and space to PolyUploader. Hosters requiring an API key are unavailable on first startup. You need to enter your personal API key to use them.
...
The upload will begin and the **created links** will be displayed directly on the interface, with the option of **copying them individually** or **copying them all**. You can also create a **unique sharing link**, which uploads the links to the PolyUploader database and makes them accessible via a link similar to this one: https://p-u.vercel.app/QZZGsMNho9. An **indicator informs you of the upload status you're at**, so how many links have been created out of the total.

![Upload links example](/img/first-file-upload/upload_links_example.png)

### Link protection

Once your upload is complete, you can also protect your generated links using encrypted paste and link protection services such as **PrivateBin**, **SafeLinking**, **Cryptgeon**, **Katbin**, **pastes.dev**, or **Filecrypt**.

You can choose to protect your links:
- **As a bundle**: a single protected paste/page containing all your upload links.
- **Individually**: each host link gets its own protected link.

For full details, see the [Link Protection](/link-protection) documentation page.
